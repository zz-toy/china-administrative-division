...
type Town struct {
	...
	Name          string     `gorm:"column:name;type:varchar(50);not null;comment:乡镇名称" json:"name"`                                                 // 乡镇名称
	Code          string     `gorm:"column:code;type:varchar(20);not null;comment:乡级代码" json:"code"`                                                 // 乡级代码
