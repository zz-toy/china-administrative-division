...
def export_pcc():
    ...
    if len(counties) > 0:
        for item in counties:
            ...
            if item.get('city_id') not in counties_city_id_dict.keys():
            ...
            if item.get('city_id') not in counties_city_id_dict_with_code.keys():
            ...
            if item.get('city_id') not in counties_city_id_dict_ui.keys():
            ...
            if item.get('city_id') not in counties_city_id_dict_ui_with_code.keys():
    ...
    if len(cities) > 0:
        for item in cities:
            ...
            if item.get('id') in counties_city_id_dict_with_code.keys():
                data_item_with_code['children'].append(counties_city_id_dict_with_code.get(item.get('id')))
            ...
            if item.get('id') in counties_city_id_dict_ui.keys():
                ui_data_item['children'].append(counties_city_id_dict_ui.get(item.get('id')))
            ...
            if item.get('id') in counties_city_id_dict_ui_with_code.keys():
                ui_data_item_with_code['children'].append(counties_city_id_dict_ui_with_code.get(item.get('id')))
